...
Business logic should depend on interfaces or ports, not infrastructure details.
...
### 4.1 Prefer Layered or Hexagonal Architecture
...
### 4.2 Use Cases Should Orchestrate

Application services/use cases coordinate domain objects and infrastructure ports.
...
7. Keep domain logic out of controllers and infrastructure.
8. Keep infrastructure details out of the domain layer.
...
- Keep transactions at service/use-case level.
